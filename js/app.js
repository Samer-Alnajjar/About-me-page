...
//if want to have a headec scroll down to see the code
...
function welcome() {
  ...
  alert(
    "I will introduce my self by asking you some questions. please answer by yes/y or no/n"
  );
}
...
function fourthQuestion() {
  ...
  if (userInput === "yes" || userInput === "y") {
    alert(
      "That's great for you, for me I don't read but I love to have this hobby in the future."
    );
...
function fifthQuestion() {
  ...
  if (userInput === "yes" || userInput === "y") {
    alert(
      "That's correct, but in the kid's pool, because I can walk in there."
    );
...
function seventhQuestion() {
  ...
  alert(
    "I love movies, please try to guess from the following movies in which movies Ryan Reynolds did act, you have six attempts"
  );
